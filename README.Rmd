...
`ecoregime` includes functions to forecast ecological trajectories from ecological dynamic regimes and assess the accuracy of the predictions. This method was introduced in:
